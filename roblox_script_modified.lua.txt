-- ============================================
-- Roblox Script متصل بـ Backend على Replit
-- ============================================
...
-- ⚠️ غير هذا الرابط بـ الرابط الخاص بك
...
-- ============================================
-- حفظ الأدوات في البيانات على Replit
-- ============================================
...
-- ============================================
-- استرجاع الأدوات من البيانات على Replit
-- ============================================
...
-- رسالة ترحيب
updateStatus("✅ متصل بـ Backend!\n\nاضغط على 'حفظ' أو 'تحميل'")
